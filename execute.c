...
int	main(void)
{
	...
	input = malloc(sizeof(t_pro *) * 2);
	input[0] = malloc(sizeof(t_pro));
	input[1] = malloc(sizeof(t_pro));

	input[0]->str = malloc(sizeof(char *) * 1);
	input[0]->str[0] = ft_strdup("ls");

	input[1]->str = malloc(sizeof(char *) * 1);
	input[1]->str[0] = ft_strdup("lsgdfgsd");
